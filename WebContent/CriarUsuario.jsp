...
<body>
    ...
    <div id="main" class="container">
        <h3 class="page-header">Realizar Cadastro</h3>
       
        <form action="ManterUser.do" method="post">
            <!-- area de campos do form -->
            <div class="row">
				<div class="form-group col-md-12">
					<label for="nome">Nome</label> <input type="text"
						class="form-control" name="nome" id="nome" required
						maxlength="100" placeholder="nome do Usuario">
				</div>
			</div>
			<div class="row">
            ...
            <div id="actions" class="row">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary" name="acao" value="Incluir">Criar</button>
